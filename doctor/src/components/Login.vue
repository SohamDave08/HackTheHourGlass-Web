        ...
        <v-container fluid grid-list-md>
            ...
            <div class="wrapper fadeInDown">
                <div id="formContent">
                    ...
                    <!-- Login Form -->
                    <form>
                        <input type="text" v-model="uid" id="login" class="fadeIn second" name="login" placeholder="User ID" autocomplete="off">
                        <input type="password" v-model="pass" id="password" class="fadeIn third" name="login" placeholder="Password" autocomplete="off">
                        <br>
                        <div class="p-2"></div>
                        <input type="button" @click="login" class="fadeIn fourth" style="background: #008275" value="Log In">
                    </form>
...
h2.active {
  color: #0d0d0d;
  border-bottom: 2px solid #008275;
}
